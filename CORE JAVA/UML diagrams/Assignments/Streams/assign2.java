...
public class assign2 {
    ...
    public static void main(String[] args) {
        News news1 = new News(1, "neha", "hema", "comment");
        News news2 =new News(2, "neha1", "hema1", "budget");
        News news3 = new News(1, "neha2", "hema2", "comment");
        News news4 = new News(3, "neha3", "hema", "budget");
        News news5 = new News(1, "neha4", "hema3", "comment");
        News news6 = new News(3, "neha5", "hema", "budget");
        News news7 = new News(1, "neha6", "hema6" ,"comment");
