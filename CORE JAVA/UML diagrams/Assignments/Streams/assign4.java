...
public class assign4 {
    ...
    public static void main(String[] args) {
    	Trader t1 = new Trader("name1", "wardha");
        Trader t2 = new Trader("name2", "Pune");
        Trader t3 = new Trader("name3", "wardha");
        ...
        Transaction ts6 = new Transaction(t6,2021,700);
        Transaction ts7 = new Transaction(t7,2021,300);
        Transaction ts8 = new Transaction(t8,2012,950);
        Transaction ts9 = new Transaction(t9,2008,500);
